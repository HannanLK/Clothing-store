<div>
    <div id="main-content" class="container mx-auto p-5">
        ...
        <!-- Sort Dropdown -->
        <select id="sortProducts" class="bg-white border border-gray-300 px-4 py-2 rounded-md mt-4">
        ...
        <button id="filterInStock" class="bg-green-500 text-white px-4 py-2 rounded-md">In Stock</button>
        ...
        <!-- Display table of existing men's products -->
        <h2 class="text-2xl font-bold mb-4">Existing Men's Products</h2>
