            ...
            <?php if (!empty($products)): ?>
                <?php foreach ($products as $product): ?>
                    <div class="relative product-card rounded-lg p-5">
                        <div class="relative">
                            <img src="<?= BASE_URL ?>images/womens/<?= $product['image'] ?>" alt="<?= htmlspecialchars($product['name']) ?>" class="w-full h-80 object-cover mb-3 rounded-md shadow-md">
            ...
            .then(products => {
                ...
                products.forEach(product => {
                    productContainer.innerHTML += `
                        <div class="relative product-card rounded-lg p-5">
                            <div class="relative">
                                <img src="<?= BASE_URL ?>images/womens/${product.image}" alt="${product.name}" class="w-full h-80 object-cover mb-3 rounded-md shadow-md">
